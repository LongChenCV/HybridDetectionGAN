    ...
    def predict_on_dataset(self,
        ...
        for j in tr:
            ...
            for k, batch_item in enumerate(y_pred):
                ...
                if self.detection_mode == 'trainval':
                    file_fid = open('/scratch/deeplearn/lc408/VOCdevkit/VOC2013/trainval/' + self.detection_times + '/' + image_id + '.txt', 'w')
                else:
                    file_fid = open('/scratch/deeplearn/lc408/VOCdevkit/VOC2013/test/' + self.detection_times + '/' + image_id + '.txt', 'w')
                ...
                for box in batch_item:
                    ...
                    if class_id == 1: class_name = 'seacucumber'
                    if class_id == 2: class_name = 'seaurchin'
                    if class_id == 3: class_name = 'scallop'
                    if self.detection_mode == 'trainval':
