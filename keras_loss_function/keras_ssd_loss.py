...
class SSDLoss:
    ...
    def compute_loss(self, y_true, y_pred):
        ...
        # Percepual Detection Loss
        neg_class_loss=0 # For object-focused percetual loss, all of the negatives don't contribute to the final loss, so we set their loss as 0
        # neg_class_loss = tf.cond(tf.equal(n_neg_losses, tf.constant(0)), f1, f2) # For patch perceptual loss.
