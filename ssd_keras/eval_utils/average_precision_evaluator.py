...
class Evaluator:
    ...
    def match_predictions(self,
        ...
        for class_id in range(1, self.n_classes + 1):
            ...
            num_chars_per_image_id = len(str(predictions[0][0])) + 12 # Keep a few characters buffer in case some image IDs are longer than others.
    ...
    def compute_precision_recall(self, verbose=True, ret=False):
        ...
        for class_id in range(1, self.n_classes + 1):
            ...
            # print("id number:{}".format(class_id))
